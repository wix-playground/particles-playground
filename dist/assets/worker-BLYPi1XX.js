(function(){"use strict";const it="random",U="DEV_EXAMPLE",rt="WIX 🤠",G="#ffffff",ot=["#ff0000","#00ff00","#0000ff"],V={fontFamily:"Arial",fontSize:90,italic:!1,weight:400,letterSpacing:0,textColor:G},st=`// This function will be called twice for each particle, because all particles reach the target in two frames.
